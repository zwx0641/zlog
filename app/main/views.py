...
log = logging.getLogger("post_operations")
handler = logging.FileHandler("post_operations.log")
...
def edit_user():
    ...
    log.info("edit_user operation triggered")
...
def edit_profile_admin(id):
    ...
    log.info("edit_profile_admin operation triggered")
...
def post(id):
    ...
    log.info("post operation triggered")
...
def create_post():
    ...
    log.info("create_post operation triggered")
...
def edit_post(id):
    ...
    log.info("edit_post operation triggered")
...
def follow(username):
    ...
    log.info("follow operation triggered")
    return redirect(url_for('main.user', username=username))
...
def unfollow(username):
    ...
    log.info("unfollow operation triggered")
    return redirect(url_for('.user', username=username))
...
def show_followed():
    ...
    resp.set_cookie('show_yours', '', max_age=30*24*60*60)
    log.info("show_followed operation triggered")
    return resp
...
def disable_comment(id):
    ...
    db.session.add(comment)
    log.info("disable_comment operation triggered")
...
def enable_comment(id):
    ...
    db.session.add(comment)
    log.info("enable_comment operation triggered")
    return redirect(url_for("main.moderate_comments", page=request.args.get('page', 1, type=int)))
